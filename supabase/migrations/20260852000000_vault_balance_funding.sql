-- ============================================================================
-- Migration: 20260852000000_vault_balance_funding.sql
-- Description: Add 'vault_deposit' ledger entry type and RPC function to purchase
--              Vault plans directly using account points balance.
-- ============================================================================

-- 1. Add 'vault_deposit' to ledger_entry_type enum
alter type public.ledger_entry_type add value if not exists 'vault_deposit';

-- 2. Create RPC function for purchasing vault plan with user points balance
...
begin
  ...
  -- Check user current points balance
  select coalesce(points_balance, 0) into v_user_balance
